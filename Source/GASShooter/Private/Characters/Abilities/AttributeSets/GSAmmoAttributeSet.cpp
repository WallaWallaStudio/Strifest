...
void UGSAmmoAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION_NOTIFY(UGSAmmoAttributeSet, PistolReserveAmmo, COND_None, REPNOTIFY_Always);
	DOREPLIFETIME_CONDITION_NOTIFY(UGSAmmoAttributeSet, MaxPistolReserveAmmo, COND_None, REPNOTIFY_Always);
}
...
void UGSAmmoAttributeSet::OnRep_PistolReserveAmmo(const FGameplayAttributeData& OldPistolReserveAmmo)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UGSAmmoAttributeSet, PistolReserveAmmo, OldPistolReserveAmmo);
}

void UGSAmmoAttributeSet::OnRep_MaxPistolReserveAmmo(const FGameplayAttributeData& OldMaxPistolReserveAmmo)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UGSAmmoAttributeSet, MaxPistolReserveAmmo, OldMaxPistolReserveAmmo);
}