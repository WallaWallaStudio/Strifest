...
void UGSAttributeSetBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION_NOTIFY(UGSAttributeSetBase, Wood, COND_None, REPNOTIFY_Always);
}
...
void UGSAttributeSetBase::OnRep_Wood(const FGameplayAttributeData& OldWood)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UGSAttributeSetBase, Wood, OldWood);
}