...
enum class EGSAbilityInputID : uint8
{
	...
	// 12 Building
	BuildingFloor			UMETA(DisplayName = "BuildingFloor"),
	// 13 BuildingWall
	BuildingWall			UMETA(DisplayName = "BuildingWall"),
	// 14 BuildingRamp
	BuildingRamp			UMETA(DisplayName = "BuildingRamp"),
	// 15 RemoveBlock
	RemoveBlock			UMETA(DisplayName = "RemoveBlock")
};
